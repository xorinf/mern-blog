        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[#e8e8ed] text-left text-[#6e6e73]">
              <th className="py-3 px-2 sm:px-4 font-medium">Title</th>
              <th className="py-3 px-2 sm:px-4 font-medium">Author</th>
              <th className="py-3 px-2 sm:px-4 font-medium">Date</th>
          ...
          <tbody>
            {articles.map((article) => (
              <tr key={article._id} className="border-b border-[#f5f5f7] hover:bg-[#f5f5f7] transition">
                <td className="py-3 px-2 sm:px-4 text-[#1d1d1f] font-medium max-w-[200px] sm:max-w-[250px] truncate">
                  {article.title}
                </td>
                <td className="py-3 px-2 sm:px-4 text-[#6e6e73]">
                  {article.author?.firstName} {article.author?.lastName || ""}
                </td>
                <td className="py-3 px-2 sm:px-4 text-[#6e6e73] whitespace-nowrap">
